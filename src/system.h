...
/*
 * Function: sys_set_lang
 * Set the active language code (e.g. "en", "zh_cn"). Called from the JS
 * frontend when the user changes the sky-map language. The code is compared
 * against a skyculture's langs_use_native_names and matched by "zh"/"ja"/...
 * prefixes, so passing the lowercased frontend code (e.g. "zh_cn") is correct.
 */
